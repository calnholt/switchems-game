...
export const TutorialSections: TutorialSection[] = [
  ...
  {
    text: `The attack value represents how much damage it will deal to the opponent's active monster.`,
    types: ['MONSTER_ACTION_ATTACK'], 
    description: 'attack',
  },
  {
    text: `The speed value represents how fast the action is - the higher the value, the faster it is. If both players select a monster action, the faster action resolves first. If the speeds are tied, the monster with the higher initiative value resolves first.`,
  ...
  {
    text: `When a monster action is selected, it becomes disabled for the following turn. You can't just spam your best moves!`,
    types: [], 
  ...
  {
    text: `Throughout the game, you will gain stat pips. There are three types - attack, speed, and defense. When you are selecting a monster action, you may also apply all of your pips from a single type. This is done by clicking a pip section when you have selected a monster action.`,
    types: ['PIP_SECTION'], 
    description: 'pips',
  },
  {
  ...
  {
    text: `On the turn a monster switches in, it gains switch in defense. Switch in defense gives the monster bonus defense against attacks with elements that it resists.`,
    types: ['RESISTANCES'],
